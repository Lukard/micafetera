  ...
  <div>
    ...
    <div class="cookies">
      ...
      <p>
        ...
        <b>https://micafetera.net</b>, estás en el lugar indicado. A
        continuación, vamos a explicarte qué son exactamente las cookies; qué
        tipo de cookies utilizamos y para qué; y cómo puedes ejercer tu derecho
      ...
      <p>
        Una <i>cookie</i> es un fichero que se descarga en tu ordenador al
        acceder a determinadas páginas web o blogs.
      </p>
      <p>
        Las <i>cookies</i> permiten a esa página, entre otras cosas, almacenar y
        recuperar información sobre tus hábitos de navegación o de tu equipo, y
      ...
      <p>
        ...
        suelen almacenar información sensible sobre ti como tarjetas de crédito
        o datos bancarios, fotografías o información personal, etc. Los datos
        que guardan son de carácter técnico, estadísticos, preferencias
        personales, personalización de contenidos, etc.
      </p>
      ...
      <p>
        ...
        consentimiento para el empleo de estas cookies. Pero, en cualquier
        momento, podrás cambiar de opinión y bloquear su utilización a través de
        tu navegador.
      </p>
      <p>
      ...
      <p>
        El reglamento LSSI-CE (<b
          >Ley de la sociedad de la información y del comercio electrónico</b
        >)
      </p>
      <p>
        El
        <b
          ...
          físicas)</b
        >, que unifica la regulación del tratamiento de los datos personales en
        los países de la UE.
      </p>
      <p>
        ...
        siendo vigente la que en cada momento se encuentre publicada en la web.
      </p>
      ...
      <p>
        ...
        <b>https://micafetera.net</b>, utiliza cookies propias y de terceros.
      </p>
      ...
      <li>
        ...
        identificar la sesión, acceder a partes de acceso restringido, recordar
        los elementos que integran un pedido, realizar el proceso de compra de
        un pedido, realizar la solicitud de inscripción o participación en un
        evento, utilizar elementos de seguridad durante la navegación, almacenar
        contenidos para la difusión de videos o sonido o compartir contenidos a
        través de redes sociales.
      </li>
      <li>
        <b>Cookies de personalización</b>: Son aquellas que permiten al usuario
        ...
        usuario como por ejemplo serian el idioma, el tipo de navegador a través
        del cual accede al servicio, la configuración regional desde donde
        accede al servicio, etc.
      </li>
      <li>
        <b>Cookies de análisis</b>: Son aquellas que bien tratadas por nosotros
        ...
        los usuarios del servicio ofertado. Para ello se analiza tu navegación
        en nuestra página web con el fin de mejorar la oferta de productos o
        servicios que le ofrecemos.
      </li>
      <li>
        <b>Cookies publicitarias</b>: Son aquellas que, bien tratadas por
        nosotros o por terceros, nos permiten gestionar de la forma más eficaz
        ...
        analizar tus hábitos de navegación en Internet y podemos mostrarte
      ...
      <li>
        ...
        Estas cookies almacenan información del comportamiento de los usuarios
      ...
      <li>
        <b>Cookies de terceros</b>: Esta web <b>https://micafetera.net</b> puede
        utilizar servicios de terceros que, por cuenta de Google, recopilarán
        información con fines estadísticos, de uso del sitio por parte del
        usuario y para la prestación de otros servicios relacionados con la
        actividad del sitio web y otros servicios de Internet.
      </li>
      <p>
        En particular, este sitio web utiliza Google Analytics, un servicio
        analítico de web prestado por Google, Inc. con domicilio en los Estados
        Unidos con sede central en 1600 Amphitheatre Parkway, Mountain View,
        California 94043. Para la prestación de estos servicios, Google utiliza
        cookies que recopilan la información, incluida la dirección IP del
        usuario, que será transmitida, tratada y almacenada por Google en los
        términos fijados en la web Google.com. Esto incluye la posible
      ...
      <p>
        En cualquier momento, puedes adaptar la configuración del navegador para
        gestionar, desestimar el uso de cookies y ser notificado antes de que se
        descarguen.
      </p>
      <p>
        También puedes adaptar la configuración de forma que el navegador
        rechace todas las <i>cookies</i>, o únicamente las <i>cookies</i> de
        terceros. Y también puedes eliminar cualquiera de las <i>cookies</i> que
        ya se encuentren en tu equipo.
      </p>
      <p>
        Para esto, debes tener en cuenta que tendrás que adaptar por separado la
        configuración de cada navegador y equipo que utilices ya que, como te
        hemos comentado anteriormente las cookies se asocian al navegador, no a
        la persona.
      </p>
      <p>
        <b>Google Chrome</b>:
